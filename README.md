# TPG-IDS
Trabajo Práctico Grupal de la materia Introducción al Desarrollo de Software - Curso Lanzillotta - 2C2025

# Hipótesis:
La hipótesis del proyecto se basa en la idea de facilitar y agilizar el intercambio de material bibliográfico entre alumnos de carreras de grado, con el objetivo de generar un beneficio mutuo para ambas partes.
